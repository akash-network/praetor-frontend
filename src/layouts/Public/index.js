...
const PublicLayout = ({ user, dispatch, children }, props) => {
  const getWidth = () => {
          ...
          {!startOverNotVisible.includes(user.akashStep) && (
            <div className="row">
              <div className="col-sm-12 col-md-6 offset-md-6 col-lg-6 offset-lg-6 col-xl-6 offset-xl-6 text-right mb-3">
                <Button onClick={() => onStartOver()} className={`mr-3 ${style.button}`}>
                  Start Over
                </Button>
              </div>
            </div>
            ...
            <div className="col-sm-12 col-md-6 offset-md-6 col-lg-6 offset-lg-6 col-xl-6 offset-xl-6 text-right">
              ...
              <div className="mr-3">
                ...
                <a href="https://discord.gg/uzUCHTF93D" target="_blank" rel="noopener noreferrer">
                  <Icon component={IconSVG} backgroundRed={() => isBackgroundRed()} {...props} />
                </a>
              </div>
            </div>
          </div>
            ...
            <div className="col-sm-12 col-md-6 offset-md-6 col-lg-6 offset-lg-6 col-xl-6 offset-xl-6 text-right">
              <div className="mr-3 pb-2">
                ...
                <div className={`${style.footer_font}`}>
                  ...
                  <div>
                    We are not responsible for any loss or damages related to using the app.
                  </div>
                </div>
              </div>
            </div>
